...
function App() {
  ...
  // if prefered color is dark it is set to dark
  // else if prefered color is light it is set to light
    ...
    const moon = (
      ...
      >
       <path
        ...
        0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 
  ...
  return (
    ...
    <button
      ...
      top-4 bg-violet-300 
      dark:bg-orange-300 text-lg p-1 
      rounded-md"
      >
        {theme === 'dark' ? sun : moon}
    </button>
